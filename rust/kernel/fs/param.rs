...
//!
//! C headers: [`include/linux/fs_parser.h`](srctree/include/linux/fs_parser.h)

use crate::types::ForeignOwnable;
use crate::{bindings, error::Result, fs, fs::file, str::CStr};
        ...
        match p.type_() {
            ...
            bindings::fs_value_type_fs_value_is_file => {
                ...
                if file_ptr.is_null() {
                    ...
                    Self::File(unsafe { file::File::from_raw_file(file_ptr) })
                }
            }
